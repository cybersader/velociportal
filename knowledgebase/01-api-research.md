...
| GET | `/tailnet/-/devices?fields=all` | Read device IDs, owner references, addresses, names, tags, and optional `sshEnabled`/`blocksIncomingConnections` presentation fields. |
